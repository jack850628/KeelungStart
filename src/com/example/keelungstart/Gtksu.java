...
public class Gtksu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item1=res.getStringArray(R.array.gtent);
		...
		if(spf.getInt("td", 0)==0){
			fg=0.003;
			teg=getString(R.string.nfg)+"300"+getString(R.string.mno)+getString(R.string.gt);
			gl="300"+getString(R.string.m);
		}else if(spf.getInt("td", 0)==1){
			fg=0.005;
			teg=getString(R.string.nfg)+"500"+getString(R.string.mno)+getString(R.string.gt);
			gl="500"+getString(R.string.m);
		}else if(spf.getInt("td", 0)==2){
			fg=0.008;
			teg=getString(R.string.nfg)+"800"+getString(R.string.mno)+getString(R.string.gt);
			gl="800"+getString(R.string.m);
		}else if(spf.getInt("td", 0)==3){
			fg=0.01;
			teg=getString(R.string.nfg)+"1"+getString(R.string.kno)+getString(R.string.gt);
			...
			teg=getString(R.string.nfg)+spf.getString("gzg","0")+gl+getString(R.string.no)+getString(R.string.gt);
		}
		if(spf.getInt("td", 0)==4){
			setTitle(getString(R.string.fggt)+"("+spf.getString("gzg","0")+gl+")");
		}else{
			setTitle(getString(R.string.fggt)+"("+gl+")");
		}
		tv.setVisibility(View.VISIBLE);
    	listview.setVisibility(View.INVISIBLE);
		tv.setText(teg);
		...
		lv=new Listview(Gtksu.this, tiem2);
	...
	class ListViewClickListener implements OnItemClickListener{
		public void onItemClick(AdapterView<?> parent,
			...
			Gtksu.this.startActivity(intent);
		}
	}
}
